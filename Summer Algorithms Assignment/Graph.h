...
public:
	...
	virtual vector<vertex> get_vertexes() const { return m_vertices; }
	virtual int get_num_of_vertexes() const { return m_num_of_vertices; }
	virtual int get_num_of_edges() const { return m_num_of_edges; }
	virtual void set_num_of_vertexes(const int i_num_of_vertexes) { m_num_of_vertices = i_num_of_vertexes; }
	virtual void set_num_of_edges(const int i_num_of_edges) { m_num_of_edges = i_num_of_edges; }
	virtual vertex& get_vertex_by_id(int i_id) { return m_vertices[i_id - 1]; }
